...
const Header = () => {
  ...
  const { isLoading, error, profile, handleLogout } = useAffinidiProfile({
    authCompleteUrl: 'https://affinidi-capstone-server.vercel.app/api/affinidi-auth/complete'
  });
  ...
  return <AffinidiLoginButton authInitUrl='https://affinidi-capstone-server.vercel.app/api/affinidi-auth/init'/>;
    };
